...
- (void)testTypes {
	...
	NSDate *ds = [NSDate distantFuture];
	NSDate *distantFuture = [Type_DateTime returnDateDatetime:ds];
	XCTAssertNotNil (distantFuture, "distantFuture");
	
	XCTAssertEqualWithAccuracy ([ds timeIntervalSinceReferenceDate], [distantFuture timeIntervalSinceReferenceDate], 0.001, "netmaxverydistantFuture");
